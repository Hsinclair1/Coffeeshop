...
if (page == "products.html") { myProducts.forEach(myFunction); }
...
function productLoop(itemNumber, numberOfProducts) {
	...
	if (itemNumber == numberOfProducts - 2) { return 0; }
	else if (itemNumber == numberOfProducts - 1) { return 1; }
	else if (itemNumber == numberOfProducts) { return 2; }
